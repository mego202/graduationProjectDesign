...
<div class="wrapper">
  ...
  <div class="content-wrapper" style="background-image:url('../test.jpg');">
    <!-- Content Header (Page header) -->
    <section class="content-header" style="bachground-color:#09c; ">
      <h1>
        Dashboard
    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            ...
            <a href="hospital.php" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
      ...
      <div class="row">
        ...
        <div id="chartContainer2" style="height: 300px; width: 45%;"></div>
