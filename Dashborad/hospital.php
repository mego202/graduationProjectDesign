...
if($do=='mange')
{
    ...
    $stm=$con->prepare("select * from hospitals");
    $stm->execute();
    $rows=$stm->fetchAll();
...
?>
    ...
    <nav class="navbar navbar-static-top" style="margin: 0 !important">
...
-->
        <a href="./index.php" style='color: #FFF; line-height: 50px; margin-left: 10px;background: #2c5e88;padding: 9px;'>
        <i class="fa fa-chevron-left" aria-hidden="true" style="margin-right: 6px;"></i>Home
      </a>
    ...
    <h1 class="text-center py-5" style="color:#888">Manage Hospital</h1>
    <div class="container">
        <div class="table-responsive">
                ...
                <form method="post" style="margin: 30px 0 40px">
                    ...
                    <?php
                        ...
                        {
                             $search=$_POST['search'];
                            $stm= $con->prepare("select * from hospitals where name LIKE '%$search%'");
                            $stm->execute();
                            $rows=$stm->fetchAll();
                        }
                    ?>
